...
|--------------|---------|---------|
| [`zhtw-traditional-chinese/`](./zhtw-traditional-chinese) | Adds 繁體中文 (zh-TW) to the Web GUI language picker; converts Simplified Chinese strings from all 27 DSH namespaces to Traditional on the fly | `dsh plugin --profile web add github:wuzhiping/cordis-plugins/zhtw-traditional-chinese` |
